...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230608_blogdipaolominopoli_26282318a4f67dcf6439_20230608155101_archive.zip';
        const ARCHIVE_SIZE       = '81833431';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '2628231-08155101';
        const SECONDARY_PACKAGE_HASH = '09d44b7-08155101';
        const VERSION            = '1.5.4';
